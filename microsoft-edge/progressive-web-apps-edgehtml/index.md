...
*   [X] [https][WikiHttps].  Proteja a los usuarios proporcionando una conexión segura para la comunicación entre servidores y aplicaciones.  Los trabajadores del servicio y otras tecnologías de PWA solo funcionan con recursos Web servidos a través de una conexión segura \ (o de `localhost` para fines de depuración \).  
  
*   [X] [trabajadores del servicio][MDNServiceWorkerApi].  Use los subprocesos de trabajo de servicio para actuar como proxies de red entre su servidor y la aplicación cliente a fin de proporcionar compatibilidad sin conexión, almacenamiento en caché de recursos, notificaciones push, sincronización de datos en segundo plano y optimizaciones del rendimiento de carga de la página.  
...
*   [X] una [cuenta de Microsoft Developer][WindowsUWPPublishDeveloperAccount]  
*   [X] pasos completados [para publicar una aplicación de Windows][WindowsUWPPublishIndex]  
