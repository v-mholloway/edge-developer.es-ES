...
Use los ****  /  **** botones de inicio de la barra de herramientas (o `Ctrl+E` ) para iniciar y concluir el seguimiento de rendimiento. En la pestaña **rendimiento** , se aparecerá un indicador verde para indicar que hay una grabación en curso. 
