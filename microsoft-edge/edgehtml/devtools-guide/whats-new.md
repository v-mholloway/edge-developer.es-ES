...
---
# DevTools en la última actualización de Windows 10 (EdgeHTML 18)
...
Hemos actualizado la aplicación independiente [Microsoft Edge DevTools Preview](./index.md#microsoft-store-app). La versión más reciente incluye el acceso de depuración remota a la funcionalidad básica del [**depurador**](./debugger.md), [**los elementos**](./elements.md) (para las operaciones de solo lectura) y los paneles de [**consola**](./console.md) .
