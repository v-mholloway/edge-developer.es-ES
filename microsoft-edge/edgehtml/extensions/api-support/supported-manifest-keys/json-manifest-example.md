...
---
# <span data-ttu-id="bbe0d-104">Ejemplo de archivo de manifiesto JSON</span><span class="sxs-lookup"><span data-stu-id="bbe0d-104">JSON manifest file example</span></span>  

[!INCLUDE [deprecation-note](../../includes/deprecation-note.md)]  

<span data-ttu-id="bbe0d-105">El siguiente fragmento de código proporciona un ejemplo de un archivo de manifiesto JSON de Microsoft Edge.</span><span class="sxs-lookup"><span data-stu-id="bbe0d-105">The following snippet provides an example of a Microsoft Edge JSON manifest file.</span></span>
