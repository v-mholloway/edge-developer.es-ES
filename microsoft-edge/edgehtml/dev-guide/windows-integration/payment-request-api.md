...
Las páginas web crean una **solicitud de pago** generalmente cuando el usuario inicia un proceso de pago haciendo clic en el botón comprar.  El **** [constructor](/previous-versions/mt790440(v=vs.85)) de la solicitud de pago incluye methodData, detalles y opciones.  
