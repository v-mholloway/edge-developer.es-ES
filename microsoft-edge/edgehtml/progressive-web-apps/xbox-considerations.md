...
2.  Ahora puedes implementar y depurar tu PWA (como una aplicación para UWP) en la Xbox One (como en cualquier otro dispositivo remoto de Windows 10) mediante el [Visual Studio Remote Debugger] (/VisualStudio/Debugger/Run-Windows-store-apps-on-a-Remote-Machine? View = vs-2017 &preserve-View = true). Como alternativa, puedes instalar tu PWA con [Device portal para Xbox](/windows/uwp/debug-test-perf/device-portal-xbox) siguiendo los pasos que se indican a continuación.
