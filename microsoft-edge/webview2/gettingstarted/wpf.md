...
---
# <a name="getting-started-with-webview2-in-wpf"></a>Introducción a WebView2 en WPF
...
1.  Mantenga el mouse sobre el proyecto, abra el menú contextual \(hacer clic con el botón secundario\) y elija **Administrar NuGet paquetes...**.  
