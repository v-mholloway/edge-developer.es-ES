...
CoreWebView2HttpHeadersCollectionIterator | Iterador para una colección de encabezados HTTP.
CoreWebView2HttpRequestHeaders | Encabezados de solicitud HTTP.
CoreWebView2HttpResponseHeaders | Encabezados de respuesta HTTP.
...
CoreWebView2WebResourceRequest | Una solicitud HTTP usada con el evento WebResourceRequested.
CoreWebView2WebResourceRequestedEventArgs | Argumentos de evento para el evento WebResourceRequested.
CoreWebView2WebResourceResponse | Una respuesta HTTP usada con el evento WebResourceRequested.
CoreWebView2WebResourceResponseReceivedEventArgs | Argumentos de evento para el evento WebResourceResponseReceived.
