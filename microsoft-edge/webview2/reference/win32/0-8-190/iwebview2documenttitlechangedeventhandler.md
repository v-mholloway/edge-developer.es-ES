...
---
# interfaz IWebView2DocumentTitleChangedEventHandler 
...
> invocación [Invoke](#invoke)pública de HRESULT ([IWebView2WebView3](IWebView2WebView3.md) * WebView, IUnknown * args)
