...
[CreateCoreWebView2EnvironmentWithDetails](#createcorewebview2environmentwithdetails) | Esta API se eliminará en la próxima versión del SDK.
...
Esta API se eliminará en la próxima versión del SDK.

Usa CreateCoreWebView2EnvironmentWithOptions.
