...
*   Para obtener más información acerca de la creación de Windows Forms, vaya a la Guía de introducción a [Windows Forms][Webview2GettingstartedWinforms] y a webView2 Windows [Forms Reference][DotnetApiMicrosoftWebWebview2Winforms] for Windows Forms specific API.  
