...
#### 1.1.8 Modificar la configuración del Configuración  
...
#### Actualización de extensiones 1.2.4  
...
#### 1.8.2 Revelar características de pago  
...
#### 1.10.5 Notificar a los usuarios de Opt-Out para Interest-Based publicidad  
