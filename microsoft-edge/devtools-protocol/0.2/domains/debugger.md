...
---
# Dominio de depuración-DevTools Protocol versión 0,2 (EdgeHTML)  
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>tanto</td>
            <td><code class="flyout">string</code> <br/> <i>Valores permitidos: punto de interrupción, paso, excepción, otro, EventListener</i></td>
        ...
        <tr>
            ...
            <td>Seguimiento de pila asincrónica de JavaScript.</td>
        </tr>
    </tbody>
</table>
</p>
...
<table>
    ...
    <tbody>
        <tr>
            <td>tipo</td>
            <td><code class="flyout">string</code> <br/> <i>Valores permitidos: global, local, con, cierre, Catch, Block, script, eval, Module, Return</i></td>
