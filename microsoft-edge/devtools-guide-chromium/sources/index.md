...
Para obtener acceso a las pestañas ocultas del panel Navegador, seleccione ![ Más fichas ](../media/more-tabs-icon.msft.png) \(**Más pestañas**\).
...
*   El **icono de** nube representa un [origen][WhatwgHtmlSpecMulitpageOriginHtmlOrigin].  
...
*   [Scripts de contenido][MdnAddOnsWebextensionsContentScripts]  
...
:::image type="complex" source="../media/pretty-printed.msft.png" alt-text="Un archivo JavaScript bastante impreso (reformateado)" lightbox="../media/pretty-printed.msft.png":::
   Un archivo JavaScript bastante impreso \(reformatted\)  
:::image-end:::  
...
Use el depurador de JavaScript para pasar por el código JavaScript devuelto por el servidor.  
El depurador incluye el **panel Depurador,** junto con los puntos de interrupción que se establecen en líneas de código en el **panel Editor.**
...
El depurador de DevTools está diseñado para que se vea, se sienta y funcione como el depurador de [Visual Studio Code][VisualStudioCodeDocsEditorDebugging] y el [depurador de Visual Studio][VisualStudioDebuggerNavigatingThroughCodeWithTheDebugger].
...
1.  Abra la página web en una nueva pestaña del explorador.  Por ejemplo, abra esta página web de formulario en una pestaña [nueva: Demo: Introducción Debugging JavaScript with Microsoft Edge (Chromium) DevTools][GlitchMicrosoftEdgeChromiumDevtoolsDebugJsGetStarted].  
...
Para obtener más información, [Visual Studio Code información general][VisualStudioCodeIndex] y la GitHub Léame, Microsoft Edge Developer Tools for [Visual Studio Code][GithubMicrosoftVscodeEdgeDevtools].
...
*   [Introducción a la depuración de JavaScript en Microsoft Edge DevTools:][DevtoolsGuideChromiumJavascriptIndex] un tutorial \(con capturas de pantalla\), mediante un proyecto simple y existente.  
