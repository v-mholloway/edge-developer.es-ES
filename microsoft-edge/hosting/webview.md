...
Como un elemento HTML [iframe](https://developer.mozilla.org/docs/Web/HTML/Element/iframe) estándar, puedes usar la vista Web para cargar páginas remotas a través de http y páginas locales (*MS-appx-Web:///*) del paquete de la aplicación. Sin embargo, la WebView también puede:
 ...
 - Proporcionarle eventos de contenido de WebView con ajuste fino:
    ...
    [MSWebViewDOMContentLoaded](#mswebviewdomcontentloaded) | Indica que los elementos principales de DOM han terminado de cargarse
    ...
    [MSWebViewUnviewableContentIdentified](#mswebviewunviewablecontentidentified) | El WebView encontró que el contenido no era HTML
    ...
    ... incluye [los eventos](#events) correspondientes para el contenido de iframe cargado en una vista previa (como [MSWebView**Frame**NavigationStarting](#mswebviewframenavigationstarting) y así sucesivamente).
